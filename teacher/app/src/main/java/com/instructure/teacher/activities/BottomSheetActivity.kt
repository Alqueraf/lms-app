...
class BottomSheetActivity : BaseAppCompatActivity(), BottomSheetInteractions, RCEFragment.RCEFragmentCallbacks {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(savedInstanceState != null) {
            bottomSheetRootView.post {
                ...
                bottomSheetRootView.setBackgroundColor(ContextCompat.getColor(this, R.color.semiTransparentDark))
            }
        } else {
    ...
    private fun fadeOutBackground() {
        ValueAnimator.ofObject(ArgbEvaluator(), ContextCompat.getColor(this, R.color.semiTransparentDark), Color.TRANSPARENT).apply {
            duration = 380
    ...
    private fun fadeInBackground() {
        ValueAnimator.ofObject(ArgbEvaluator(), Color.TRANSPARENT, ContextCompat.getColor(this, R.color.semiTransparentDark)).apply {
            duration = 280
            addUpdateListener { animator -> bottomSheetRootView.setBackgroundColor(animator.animatedValue as Int) }
        }.start()
    }
