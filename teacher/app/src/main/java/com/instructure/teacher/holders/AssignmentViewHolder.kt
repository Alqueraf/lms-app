    ...
    fun bind(context: Context, assignment: Assignment, courseColor: Int, callback: (Assignment) -> Unit) = with(itemView){
        ...
        if(assignment.allDates.size > 1) {
            ...
            if (assignment.dueAt != null) {
                dueDate.text = closedString + context.getString(R.string.due, DateHelper.getMonthDayTimeMaybeMinutesMaybeYear(context, assignment.dueAt, R.string.at))
                ...
                dueDate.text = closedString + context.getString(R.string.due, DateHelper.getMonthDayTimeMaybeMinutesMaybeYear(context, assignment.allDates.get(0).dueAt, R.string.at))
            } else {
