...
class RatingDialog : DialogFragment() {
        ...
        send.setOnClickListener {
            ...
            if (message.isBlank()) {
                ...
                val appTitle = when (appType) {
                    AppType.CANDROID -> getString(R.string.utils_canvas)
                ...
                intent.resolveActivity(activity.packageManager)?.let { startActivity(intent) }
            }
    ...
    private fun populateMailIntent(subject: String, title: String): Intent {
        ...
        if (user != null) {
            emailBody += activity.getString(R.string.utils_userId) + ": " + user.id + "\n"
            emailBody += activity.getString(R.string.utils_email) + ": " + user.primaryEmail + "\n"
        }
        emailBody += activity.getString(R.string.utils_domain) + ": " + ApiPrefs.domain + "\n"
        emailBody += activity.getString(R.string.utils_versionNum) + " " + versionName + " " + versionCode + "\n"
