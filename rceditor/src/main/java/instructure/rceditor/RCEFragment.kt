...
class RCEFragment : Fragment() {
    ...
    private val onColorChosen = View.OnClickListener { v ->
        when (v.id) {
            ...
            R.id.rce_colorPickerGray -> rcEditor.setTextColor(ContextCompat.getColor(context, R.color.rce_pickerGray))
            R.id.rce_colorPickerRed -> rcEditor.setTextColor(ContextCompat.getColor(context, R.color.rce_pickerRed))
            R.id.rce_colorPickerOrange -> rcEditor.setTextColor(ContextCompat.getColor(context, R.color.rce_pickerOrange))
            R.id.rce_colorPickerYellow -> rcEditor.setTextColor(ContextCompat.getColor(context, R.color.rce_pickerYellow))
            R.id.rce_colorPickerGreen -> rcEditor.setTextColor(ContextCompat.getColor(context, R.color.rce_pickerGreen))
            R.id.rce_colorPickerBlue -> rcEditor.setTextColor(ContextCompat.getColor(context, R.color.rce_pickerBlue))
            R.id.rce_colorPickerPurple -> rcEditor.setTextColor(ContextCompat.getColor(context, R.color.rce_pickerPurple))
        }
    ...
    private fun setupViews() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            activity.window.statusBarColor = ContextCompat.getColor(context, R.color.rce_dimStatusBarGray)
