 ...
 *
 */
package com.instructure.candroid.router
...
object RouteMatcher : BaseRouteMatcher() {
    ...
    private fun initRoutes() {
        ...
        */
        ...
        routes.add(Route(courseOrGroup("/:${RouterParams.COURSE_ID}/grades/:${RouterParams.ASSIGNMENT_ID}"), GradesListFragment::class.java, AssignmentFragment::class.java))
        ...
        routes.add(Route(courseOrGroup("/:${RouterParams.COURSE_ID}/assignments/:${RouterParams.ASSIGNMENT_ID}"), AssignmentListFragment::class.java, AssignmentFragment::class.java))
        routes.add(Route(courseOrGroup("/:${RouterParams.COURSE_ID}/assignments/:${RouterParams.ASSIGNMENT_ID}"), ScheduleListFragment::class.java, AssignmentFragment::class.java))
        routes.add(Route(courseOrGroup("/:${RouterParams.COURSE_ID}/assignments/:${RouterParams.ASSIGNMENT_ID}"), NotificationListFragment::class.java, AssignmentFragment::class.java))
        routes.add(Route(courseOrGroup("/:${RouterParams.COURSE_ID}/assignments/:${RouterParams.ASSIGNMENT_ID}"), CalendarListViewFragment::class.java, AssignmentFragment::class.java))
        ...
        routes.add(Route(courseOrGroup("/:${RouterParams.COURSE_ID}/assignments/:${RouterParams.ASSIGNMENT_ID}/:${RouterParams.SLIDING_TAB_TYPE}"), AssignmentListFragment::class.java, AssignmentFragment::class.java))
        routes.add(Route(courseOrGroup("/:${RouterParams.COURSE_ID}/assignments/:${RouterParams.ASSIGNMENT_ID}/:${RouterParams.SLIDING_TAB_TYPE}/:${RouterParams.SUBMISSION_ID}"), AssignmentListFragment::class.java, AssignmentFragment::class.java))
        ...
        routes.add(Route(courseOrGroup("/:${RouterParams.COURSE_ID}/conferences.*"), UnsupportedFeatureFragment::class.java, Tab.CONFERENCES_ID)) //No longer supported. Left here so you read this and know.

        routes.add(Route("/files", FileListFragment::class.java))
        ...
        routes.add(Route(courseOrGroup("/:${RouterParams.COURSE_ID}/assignments/:${RouterParams.ASSIGNMENT_ID}"), AssignmentFragment::class.java, null))
...
//        bottomSheetFragments.add(EditFavoritesFragment::class.java)
    ...
    fun route(context: Context, route: Route?) {
        ...
        if (route == null || route.routeContext == RouteContext.DO_NOT_ROUTE) {
            ...
            }  else if (route.paramsHash.containsKey(RouterParams.FOLDER_NAME)) {
    ...
    private fun handleMediaRoute(context: Context, route: Route) {
        ...
        context.startActivity(BaseViewMediaActivity.createIntent(context, route))
    }

    private fun handleWebViewRoute(context: Context, route: Route) { //TODO: probably want to handle this in a fragment instead?
        route.routeType = RouteType.WEBVIEW
