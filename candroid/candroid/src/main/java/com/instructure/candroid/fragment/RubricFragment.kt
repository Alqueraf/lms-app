...
class RubricFragment : ParentFragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater?, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        rubricRecyclerAdapter = RubricRecyclerAdapter(context, canvasContext, object : AdapterToFragmentCallback<Any> {
        ...
        configureRecyclerView(rootView, context, rubricRecyclerAdapter!!, R.id.swipeRefreshLayout, R.id.emptyPandaView, R.id.listView)
     ...
     *
     * For explanation of isWithinAnotherCallback and isCached refer to comment in [com.instructure.candroid.activity.CallbackActivity]
     */
    @BeforePageView
    fun setAssignment(assignment: Assignment, isWithinAnotherCallback: Boolean, isCached: Boolean) {
        rubricRecyclerAdapter?.let {
            ...
            it.loadDataChained(isWithinAnotherCallback, isCached)
        }
    }
    //endregion
