...
open class InternalWebviewFragment : ParentFragment() {
    ...
    var canvasContext: CanvasContext by ParcelableArg(default = ApiPrefs.user, key = Const.CANVAS_CONTEXT)
        ...
        with(rootView) {
            ...
            canvasWebView.canvasWebViewClientCallback = object : CanvasWebView.CanvasWebViewClientCallback {
                ...
                override fun canRouteInternallyDelegate(url: String): Boolean {
                    return shouldRouteInternally && !isUnsupportedFeature && RouteMatcher.canRouteInternally(activity, url, ApiPrefs.domain, false)
                }
    ...
    fun shouldRouteInternally(shouldRouteInternally: Boolean) {
