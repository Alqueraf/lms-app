...
class CourseSettingsFragment : ParentFragment(), DatePickerFragment.DatePickerCancelListener {
    ...
    override fun onViewCreated(view: View?, savedInstanceState: Bundle?) {
        ...
        license.text = course.licensePrettyPrint
        ...
        startLayout.setVisible(course.startDate != null).startDate.text =
                DateHelper.dateToDayMonthYearString(context, course.startDate)
        endLayout.setVisible(course.endDate != null).endDate.text =
                DateHelper.dateToDayMonthYearString(context, course.endDate)
    }
