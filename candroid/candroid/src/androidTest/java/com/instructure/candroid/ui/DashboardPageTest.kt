...
import com.instructure.candroid.ui.utils.StudentTest
import com.instructure.candroid.ui.utils.seedData
import com.instructure.candroid.ui.utils.tokenLogin
...
class DashboardPageTest : StudentTest() {
    ...
    private fun getToDashboard(courseCount: Int = 1) : SeededData {
