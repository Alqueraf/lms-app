...
object RollingBuilds {
    ...
    fun disable(appSlug: String): Status {
        return apiService.disable(appSlug).execute().body()
    }

    fun enable(appSlug: String): Status {
        return apiService.enable(appSlug).execute().body()
    }
}
