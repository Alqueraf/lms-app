...
import api.buddybuild.BuddybuildApps
...
class CloudApps(private val isBitrise: Boolean) {
    ...
    fun getApps(): List<ToNormalApp> {
        return if (isBitrise) BitriseApps.getAppsForOrg() else BuddybuildApps.getApps()
    }
    ...
    companion object {
        fun getNormalBuilds(app: Any,
            ...
            return when (app) {
                ...
                is BuddybuildAppObject -> BuddybuildApps.getBuilds(app, limitDateAfter, limitDateBefore).mapNotNull { it.toNormalBuild() }
