...
object Randomizer {
    ...
    fun randomAssignment(withDescription: Boolean = false, lockAt: String, unlockAt: String, dueAt: String, submissionTypes: List<SubmissionType>, groupCategoryId: Long?): CreateAssignment =
            CreateAssignment(
