...
object EnrollmentsApi {
    ...
    private fun enrollUser(courseId: Long, userId: Long, enrollmentType: String, associatedUserId: Long? = null): EnrollmentApiModel {
    ...
    private fun enrollUserInSection(sectionId: Long, userId: Long, enrollmentType: String): EnrollmentApiModel {
