...
class FeatureFlagsTest {
    ...
    fun setAccountFeatureFlag() {
        ...
        val state = "on"
        val request = SetAccountFeatureFlagRequest.newBuilder()
                .setFeature(feature)
                .setState(state)
                .build()
        val featureFlag = InProcessServer.featureFlagClient.setAccountFeatureFlag(request)
        assertThat(featureFlag, instanceOf(FeatureFlag::class.java))
