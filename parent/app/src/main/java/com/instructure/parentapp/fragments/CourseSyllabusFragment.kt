    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        description.canvasEmbeddedWebViewCallback = object : CanvasWebView.CanvasEmbeddedWebViewCallback {
            ...
            override fun launchInternalWebViewFragment(url: String) {
                ...
                internalWebviewFragment.arguments = InternalWebViewFragment.createBundle(url + RequestInterceptor.getSessionLocaleString(), "", null, student)
        ...
        description.canvasWebViewClientCallback = object : CanvasWebView.CanvasWebViewClientCallback {
            ...
            override fun canRouteInternallyDelegate(url: String): Boolean {
                ...
                return RouterUtils.canRouteInternally(null, url, student, uri.host, false)
            }

            override fun routeInternallyCallback(url: String) {
                val uri = Uri.parse(url)
                RouterUtils.canRouteInternally(activity, url, student, uri.host, true)
            }
        }
    }
