...
class CourseListFragment :
    ...
    private var student: User by ParcelableArg(key = Const.USER)
    ...
    override fun getPresenterFactory(): PresenterFactory<CourseListPresenter> {
        return CourseListPresenterFactory(student)
    }
                    ...
                    if (course != null) {
                        ...
                        startActivity(
                            DetailViewActivity.createIntent(
                                context, DetailViewActivity.DETAIL_FRAGMENT.WEEK, presenter.student, course
                            )
                        )
    ...
    companion object {
        ...
        fun newInstance(student: User): CourseListFragment {
            val args = Bundle()
