...
class DetailViewActivity : BaseRouterActivity() {
        ...
        if (fragmentType != null) {
            ...
            when (fragmentType) {
                DetailViewActivity.DETAIL_FRAGMENT.WEEK -> {
                    ...
                    val course = intent.extras?.getSerializable(Const.COURSE) as Course?
                ...
                DetailViewActivity.DETAIL_FRAGMENT.SYLLABUS -> {
                    val syllabusCourse = intent.extras?.getSerializable(Const.COURSE) as Course
    ...
    companion object {
        private val FRAGMENT_TRANSACTION_DELAY_TIME = 1000
        ...
        fun createIntent(context: Context, fragment: DETAIL_FRAGMENT, scheduleItem: ScheduleItem, student: User): Intent {
            ...
            intent.putExtra(Const.STUDENT, student as Parcelable)
            return intent
        }
