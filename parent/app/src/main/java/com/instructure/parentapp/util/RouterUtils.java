...
public class RouterUtils {
    ...
    public enum ROUTE_TYPE {INTERNALLY_ROUTED, FILE_DOWNLOAD, NOT_INTERNALLY_ROUTED, NOTIFICATION_PREFERENCES, ACCOUNT_NOTIFICATION};
    ...
    static {
        ...
        sRoutes.add(new Route("/accounts/self/users/:student_id/account_notifications/:notification_id", ROUTE_TYPE.ACCOUNT_NOTIFICATION));
